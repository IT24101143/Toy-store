...
<head>
    ...
    <title>Add Payment - Toy Store</title>
    ...
    <div class="container">
        <div class="payment-container">
            <div class="text-center">
                ...
                <h1 class="store-title">Add Payment Method</h1>
                <p class="text-muted">Secure payment for your toy adventures!</p>
            </div>
            ...
            <form action="add-payment" method="post">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control" id="expiryDate" name="expiryDate" placeholder="MM/YY" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="cvv" name="cvv" maxlength="3" minlength="3" required>
                    </div>
                </div>
