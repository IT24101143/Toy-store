...
<head>
    ...
    <style>
        ...
        .alert-warning {
            background: linear-gradient(135deg, var(--accent-color), #f8d7da);
            color: #856404;
        }
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/OrderHistory.jsp">
                            <i class="fas fa-history me-1"></i>Order History
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="EditOrder.jsp">
    ...
    <div class="container mt-4 animate-fade-in">
        ...
        <c:if test="${order.status != 'PENDING'}">
            <div class="alert alert-warning mt-4 animate__animated animate__fadeIn">
                ...
                This order cannot be edited because it is no longer in PENDING status.
                <a href="${pageContext.request.contextPath}/OrderHistory.jsp" class="alert-link">
        ...
        <c:if test="${order.status == 'PENDING'}">
            <form action="${pageContext.request.contextPath}/update.jsp" method="post" class="mt-4" id="editForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="deliveryAddress" name="deliveryAddress" 
                                                  rows="3" required>${order.deliveryAddress}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" id="paymentMethod" name="paymentMethod" required>
                                            ...
                                            <option value="CREDIT_CARD" ${order.paymentMethod == 'CREDIT_CARD' ? 'selected' : ''}>
                                                <i class="fab fa-cc-visa"></i> Credit Card
                                            </option>
                                            <option value="DEBIT_CARD" ${order.paymentMethod == 'DEBIT_CARD' ? 'selected' : ''}>
                                                <i class="fas fa-credit-card"></i> Debit Card
                                            </option>
                                            <option value="PAYPAL" ${order.paymentMethod == 'PAYPAL' ? 'selected' : ''}>
